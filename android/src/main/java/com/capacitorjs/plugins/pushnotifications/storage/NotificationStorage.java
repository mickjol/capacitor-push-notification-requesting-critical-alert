package com.capacitorjs.plugins.pushnotifications.storage;
...
public class NotificationStorage {
    ...
    public NotificationStorage(ContentResolver contentResolver) {
    ...
    public void save(String deviceId, String notificationLogId, String interventionId, String origin) {
        try {
            ...
            Log.e("NotificationStorage", "logNotification : " + ex.getMessage());
        }
    }
